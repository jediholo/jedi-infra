...
dns_records = [
  ...
  { name = "",                      ttl = 300,   type = "TXT",    target = "\"google-site-verification=_20vklpumKjTDIdPh0jiFaUlXiVl4ho56OS6ZwJQNqs\"" },
  { name = "_dmarc",                ttl = 600,   type = "DMARC",  target = "v=DMARC1;p=none;rua=mailto:postmaster@jediholo.net;" },
  { name = "comport",               ttl = 1800,  type = "CNAME",  target = "srv01" },
  { name = "comport.dev",           ttl = 300,   type = "A",      target = "127.0.0.12" },
  { name = "demo",                  ttl = 300,   type = "CNAME",  target = "jka02" },
  ...
  { name = "galaxy",                ttl = 300,   type = "CNAME",  target = "jka02" },
  { name = "grounds",               ttl = 300,   type = "CNAME",  target = "jka02" },
  { name = "jka02",                 ttl = 1800,  type = "CNAME",  target = "ipv4.ks13.srv.fabinfra.net." },
  ...
  { name = "temple",                ttl = 300,   type = "CNAME",  target = "jka02" },
